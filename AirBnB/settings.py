...
DEBUG = True  # False because i am hosting it.

# Here we add the hosts to be used.
ALLOWED_HOSTS = ['salamabnb.vercel.app', 'localhost', '127.0.0.1',
                 '*']  # removed * coz it want's precision
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://b52ffe93-7d54-44cc-93a4-240f31240709-00-1z3o8p8tnfub4.worf.replit.dev'
]
